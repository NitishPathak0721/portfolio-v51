...
const AboutPage = () => {
  ...
  useEffect(() => {
    ...
    const updateStats = () => {
      ...
      // Experience will be updated once actual
      // experience/start date is provided.
  ...
  const statsData = useMemo(
    () => [

      {
        ...
        description: "Projects built and developed",
...

      {
        ...
        label: "Certificates",
        description: "Skills and learning achievements",
        animation: "fade-up"
      },
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="space-y-6 text-center lg:text-left">
            ...
            >
              ...
              I am a student and technology enthusiast with a strong
              interest in software development and modern web technologies.
              I enjoy building projects, solving programming problems and
