...
const ProjectDetails = () => {
  ...
  useEffect(() => {
    ...
    // Find project based on slug generated from Title
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...
        Github:
          ...
          "https://github.com/NitishPathak0721",
      };
  ...
  return (
    <>
      <Helmet>
        <title>{project.Title} — Nitish Pathak</title>
        ...
        <meta
          ...
          content={
            project.Description
              ...
              : `Project ${project.Title} by Nitish Pathak — Frontend Web Developer.`
          }
        />
        ...
        <meta
          property="og:title"
          content={`${project.Title} — Nitish Pathak`}
        />
